...
url = 'https://simpcity.su/threads/sofiacrnilovic.67319/page-2'  # Remplacer par l'URL de la page que vous souhaitez récupérer
filename = os.path.join(script_directory, '1_sortie_code_source.txt')  # Nom du fichier où le code source sera sauvegardé
